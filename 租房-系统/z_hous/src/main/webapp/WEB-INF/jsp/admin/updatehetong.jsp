...
<body style="background: url(imgs/背景图.png);background-size:cover;">
<body>
...
<div class="sidebar-title">
        <form action="${pageContext.request.contextPath}/hetong/changehetong" method="post" id="myform" name="myform" enctype="multipart/form-data" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                                <th><i class="require-red">*</i>房屋id：</th>
                                <td>
                                    <input class="common-text required" value="${hetong.houseId}" id="house_id" name="house_id" size="50" type="text" readonly>
                                </td>
                            </tr>
                            <tr>
                           ...
                           <tr>
                                ...
                                <td><input class="common-text" name="chuzu_idcard" value="${hetong.chuzuIdcard}" id="chuzu_idcard" size="50" type="text"></td>
                            </tr>
                             <tr>
                            ...
                            <tr>
                              ...
                              <td><input class="common-text" name="zuke_idcard" value="${hetong.zukeIdcard}" id="zuke_idcard" size="50" type="text"></td>
                            </tr>
                             <tr>
