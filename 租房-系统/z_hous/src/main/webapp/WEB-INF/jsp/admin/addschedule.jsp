...
<div class="sidebar-title">
        <form action="${pageContext.request.contextPath}/schedule/insertschedule" method="post" id="myform" name="myform" enctype="multipart/form-data" >
