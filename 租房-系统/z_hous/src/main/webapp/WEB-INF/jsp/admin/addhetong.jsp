        ...
        <form action="/hetong/inserthetong" method="post" id="myform" name="myform" enctype="multipart/form-data" >
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                                ...
                                <td>
                                    <input class="common-text required" value="${hetong.houseId}" id="houseId" name="houseId" size="50" type="text" readonly>
                                </td>
                            </tr>
                            <tr>
                           ...
                           <tr>
                                ...
                                <td><input class="common-text" name="chuzuIdcard" value="${hetong.chuzuIdcard}" id="chuzuIdcard" size="50" type="text"></td>
                            </tr>
                             <tr>
                            ...
                            <tr>
                              ...
                              <td><input class="common-text" name="zukeIdcard" value="${hetong.zukeIdcard}" id="zukeIdcard" size="50" type="text"></td>
                            </tr>
                             <tr>
