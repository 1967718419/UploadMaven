...
<body>
	<div>
		...
		<form id="houseForm" name="houseForm"
			action="/house/zulist/myzulist" method=post>
			<div class="result-title">
...
<c:forEach items="${userlist.zulist}" var="zulist">
								...
								<td>${userlist.phone}</td>
									...
									<td><a class="link-update"
										href="/house/hetong/zukeseehetong?houseId=${zulist.houseId }">查看合同</a>
										&nbsp;&nbsp; <a class="link-del"
										href="/house/applyout/insertapplyout?houseId=${zulist.houseId }"
