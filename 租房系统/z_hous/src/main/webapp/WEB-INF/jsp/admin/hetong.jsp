...
<body>
<div><br />
	<form name="hetong" action="/house/hetong/updatehetong">
	<div class="title">房屋租赁合同</div>
	<u><input type="hidden" name="house_id" value="${hetong.houseId}"/></u>
	<p>出租方：<u><span name="chuzu">${hetong.chuzu}</span></u>（以下简称甲方）；</p>　　　
	<p>承租方：<u><span name="zuke">${hetong.zuke}</span></u>（以下简称乙方）。　</p>　
	<p>租赁房屋地址：<u><span name="zuke">${hetong.address}</span></u>　</p>　
	<p>依据《中华人民共和国合同法》有关条款，甲乙双方经过充分协商，就乙方租赁甲方房屋事宜达成如下协议：</p>
	<p>一、乙方租赁甲方房屋，以下简称租赁房屋。</p>
	<p>二、起租时间：<u><span name="fromdate" >${hetong.fromdate}</span></u>，退租时间：<u><span name="todate">${hetong.todate}</span></u>。
	在合同签订之日，乙方需向甲方支付房屋租金￥<u><span name="price">${hetong.price}</span></u>。如续租，请提前3天通知甲方，并重新办理租赁手续。<br /></p>　　　　
	<p>三、违约处理：</p>　
	<p>甲方违约：</p>　
