...
<div class="sidebar-title">
        <form action="${pageContext.request.contextPath}/paid/inserttopaid" method="post" id="myform" name="myform" enctype="multipart/form-data" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                                <th><i class="require-red">*</i>房屋id：</th>
                                <td>
                                    <input class="common-text required" value="${zulist.houseId}" id="house_id" name="houseId" size="50" type="text" readonly>
                                </td>
                            </tr>
                            <tr>
                           ...
                           <tr>
                             ...
                             <tr>
                              ...
                              <td><input class="common-text" name="price" value="" id="zuke" size="50" type="text"></td>
                                ...
                                <input type="hidden" name="userlist_id" id="userlist_id" value="${zulist.userlistId}"/>
								<tr>
                                <th></th>
                                <td>
