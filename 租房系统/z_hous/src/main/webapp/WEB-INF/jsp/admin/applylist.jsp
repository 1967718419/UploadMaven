...
<body>
	...
	<div>
		<form id="houseForm" name="houseForm" action="findapplylist" method=post>
			<div class="result-title">
				...
				<tbody>
					...
					<c:forEach items="${applylist}" var="apply">
						<tr
							...
							<td>
								<a class="link-update" href="/zulist/toaddhetong?houseId=${apply.houseId}">同意租赁</a>
								&nbsp;&nbsp; <input type="hidden" name="id" value="${houselist.id}" />
								<a class="link-del" href="refuseapply?houseId=${apply.houseId}&name=${apply.userlist.name }" onclick="return window.confirm('确定要拒绝该租客的申请吗？')">拒绝租赁</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
