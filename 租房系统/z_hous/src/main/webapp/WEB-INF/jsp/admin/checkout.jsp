...
<div>
	<form id="houseForm" name="houseForm" action="/checkout/getallcheckout" method=post >
						 <div class="result-title">
								...
								<c:forEach items="${checkout}" var="checkout">
									<tr
										...
										<td>
											...
											<input type="hidden" name="cid" value="${checkout.cid}"/>
											<a class="link-del"
											 href="/checkout/admindeletecheckout?cid=${checkout.cid}"
