...
<div class="sidebar-title">
        <form action="${pageContext.request.contextPath}/wrong/insertwrong" method="post" id="myform" name="myform" enctype="multipart/form-data" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                        	<tr>
                                <th><i class="require-red">*</i>房屋id：</th>
                                <td>
                                    <input class="common-text required" value="${zulist.houseId}" id="house_id" name="houseId" size="50" type="text" >
                                </td>
                            </tr>
                            <tr>
                           ...
                           <tr>
                             ...
                             <tr>
                                ...
                                <input type="hidden" name="userlistId" id="userlist_id" value="${zulist.userlistId}"/>
								<tr>
                                <th></th>
                                <td>
