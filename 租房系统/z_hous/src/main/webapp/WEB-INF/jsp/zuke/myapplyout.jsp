...
<body>
	<div>
		...
		<form id="houseForm" name="houseForm"
			action="${pageContext.request.contextPath}/applyout/getmyapplyout" method=post>
			<div class="result-title">
							...
							<tr style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
								...
								<td>${userlist.phone}</td>
								    ...
								    <c:if test="${ applyout.status!='申请中'}">
										<a class="link-update" href="${pageContext.request.contextPath}/applyout/deleteapplyout?aoid=${applyout.aoid}"
